            ...
            <div className="Content">
                ...
                <div className="Hollow">
                    <div className="Code">
                        ...
                        &#123;college&#125;,<span id="value">From: </span><br/>&emsp;&emsp;&emsp;&emsp;&#123;joining_year&#125;,<span id="value">To: </span>&#123;graduating_year&#125;<span id="value">"</span>&#41;<br/><br/>

                        &emsp;&emsp;<span id="keyword">def </span><span id="func">Projects</span>(self):<br/>
                        &emsp;&emsp;&emsp;&emsp;proj_name = <span id="value">"Mobile Computational Offloading using Machine
                        <br/>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Learning Techniques"</span><br/>
